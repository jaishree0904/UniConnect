...
<body>
        ...
        <div class="container main-nav flex">
            ...
            <div class="nav-links" id="nav-links">
                <ul class="flex">
                    ...
                    <li><a href="project.php" class="hover-link">Project</a></li>
    ...
    <table>
    <TR>
        <TD>Welcome <b><?php echo $UserName?></b> !!</TD>
    </TR>
    <TR><TD>Your account successfully registered in UniConnect</TD></TR>
    <TR><TD><br/><br/><br/><br/>
    <TR><TD>
    <a href="./project.php?st=view"><button class="btn">Continue to fill your project details..</button></a>
    </TD></TR>
    </table>
</div>
